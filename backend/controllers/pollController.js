    ...
    exports.createPoll = async (req, res) => {
            ...
            switch (type) {
                case "single-choice":
                    if (!options || options.length < 2) {
                        ...
                        message: "At least two options are required for single-choice polls", 
                        });
                    }
                    ...
                    case "image-based":
                        if (!options || options.length < 2){
                            return res.status(400).json({
                                message:"Image-based poll must have at least two URLs,",
                            });
                        }
        ...
        exports.getAllPolls = async (req, res) => {
            ...
            try {
                // calulate pagination parametres
                ...
                const updatedPolls = polls.map((poll) => {
                    const userHasVoted = poll.voters.some((voteId) =>
                        voteId.equals(userId)
                );
                return { 
                ...poll.toObject(),
                 userHasVoted,
            ...
            res.status(200).json({
                ...
                res.status(500)
                .json({ message: "Error registring polls", error: err.message });
            }
        };
        ...
        exports.getVotedPolls = async (req, res) => {
            ...
            try {
                ...
                const pageNumber = parseInt(page, 10 );
                const pageSize = parseInt(limite, 10 );
                const skip = (pageNumber - 1) * pageSize;
        ...
        exports.voteOnPoll = async (req, res) => {
            ...
            res.status(200).json(poll);
                ...
                res.status(500)
                .json({ message: "Error voting on polls", error: err.message });
            }
        };
        ...
        exports.getBookmarkedPolls = async (req, res) => {
            ...
            try {
                ...
                res.status(500)
                .json({ message: "Error deleted polls", error: err.message });
            }
        };
